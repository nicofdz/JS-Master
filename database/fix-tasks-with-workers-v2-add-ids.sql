-- =====================================================
-- FIX: Add tower_id, floor_id, apartment_id to tasks_with_workers_v2
-- =====================================================
-- The view was missing these IDs, only had numbers, causing the hierarchical
-- grouping in the frontend to fail.
...
'Vista de tareas con información completa de trabajadores, apartamento, piso, torre y proyecto. Incluye IDs para filtrado jerárquico.';

-- Verify the view has all needed columns
SELECT 
  column_name, 
  data_type
FROM information_schema.columns
WHERE table_name = 'tasks_with_workers_v2'
  AND column_name IN ('tower_id', 'floor_id', 'apartment_id')
