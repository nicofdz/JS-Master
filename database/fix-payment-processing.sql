...
-- Función corregida para procesar pagos (solo tareas completadas)
...
BEGIN
  ...
  -- Por ahora no crear relaciones de pago hasta que la tabla esté disponible
  -- TODO: Implementar payment_tasks cuando la tabla esté disponible
...
COMMENT ON FUNCTION public.process_worker_payment IS 'Procesa pagos solo para tareas completadas, manteniendo tareas pendientes/en progreso sin tocar';
