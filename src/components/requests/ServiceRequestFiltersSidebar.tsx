import { X, Filter, FolderKanban } from 'lucide-react'
import { Button } from '@/components/ui/Button'

interface ServiceRequestFiltersSidebarProps {
    isOpen: boolean
    onClose: () => void
...
export function ServiceRequestFiltersSidebar({
    isOpen,
    onClose,
    currentStatusFilter,
    onStatusFilterChange,
    counts
}: ServiceRequestFiltersSidebarProps) {
                            ...
                            <div className="group">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        <option value="contacted">Contactados ({counts.contacted})</option>
                                        <option value="quoted">Cotizados ({counts.quoted})</option>
                                        <option value="closed">Cerrados ({counts.closed})</option>
                                    </select>
