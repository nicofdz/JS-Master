import { X, Layers, Briefcase, Filter } from 'lucide-react'
import { Button } from '@/components/ui/Button'

interface JobApplicationsFiltersSidebarProps {
    isOpen: boolean
    onClose: () => void
...
export function JobApplicationsFiltersSidebar({
    isOpen,
    onClose,
    currentStatusFilter,
    onStatusFilterChange,
    counts
}: JobApplicationsFiltersSidebarProps) {
                            ...
                            <div className="group">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        <option value="hired">Contratados ({counts.hired})</option>
